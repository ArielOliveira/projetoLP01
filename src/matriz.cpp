...
int **MultMatrizesR(int **M1, int **M2, int **M3, int n) {
	if(n == 1) {
		...
		deleteMatriz(M1_11, n/2);
		deleteMatriz(M1_12, n/2);
		deleteMatriz(M1_21, n/2);
		deleteMatriz(M1_22, n/2);

		deleteMatriz(M2_11, n/2);
		deleteMatriz(M2_12, n/2);
		deleteMatriz(M2_21, n/2);
		deleteMatriz(M2_22, n/2);

		deleteMatriz(M3_11, n/2);
		deleteMatriz(M3_12, n/2);
		deleteMatriz(M3_21, n/2);
		deleteMatriz(M3_22, n/2);

		deleteMatriz(P_1, n/2);
		deleteMatriz(P_2, n/2);
		deleteMatriz(P_3, n/2);
		deleteMatriz(P_4, n/2);
		deleteMatriz(P_5, n/2);
		deleteMatriz(P_6, n/2);
		deleteMatriz(P_7, n/2);
		deleteMatriz(P_8, n/2);
